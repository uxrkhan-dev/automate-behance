(async function automateBehance() {
    ...
    let comments = [
        ...
        "Great project!", "everything is so stylish","Love it!",
        "Fantastic work.",
        "wonderful project!",
        "interesting",
        "God Job",
        "Super cool element and presentation",
        "Minimal, bold, and beautifully structured! 😁",
        "wow, nice element",
        "Wow, awesome 👏🏻🤩",
        "Muy buen trabajo!",
        "Wow great design",
        ...
        ":)-lovely and quite impressive work you have here",
